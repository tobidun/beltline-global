    ...
    >
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-[#1A2A44] lg:whitespace-nowrap">
        ...
        <section className="rounded-3xl border border-slate-200 bg-slate-100 p-8 shadow-sm">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#2B5FBF]">
            Director&apos;s profile
          </p>
          <h2 className="mt-4 text-2xl font-semibold text-[#1A2A44]">
            Adam I. Ajao
          </h2>
